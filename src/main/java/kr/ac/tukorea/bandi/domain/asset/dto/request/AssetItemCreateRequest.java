...
public record AssetItemCreateRequest(
        @NotBlank @Size(max = 100) String name,
        @NotBlank @Size(max = 50) String categoryCode,
        @NotNull AssetTrackingType trackingType,
    ...
    public AssetItemCreateParam toParam() {
        return new AssetItemCreateParam(name, categoryCode, trackingType,
