...
<t:layout title="공연 콘텐츠" active="performance-content-management" role="${role}" scriptPath="performance/content-management">
    ...
    <t:sheet id="publicProfileSheet" title="공개 프로필" description="외부 참여자는 내부 멤버를 선택하지 않아도 돼요.">
    ...
    <t:sheet id="profilePolicySheet" title="프로필 동의 문서" description="게시한 본문은 수정하지 않고 새 버전으로 발행해요.">
    ...
    <t:sheet id="characterSheet" title="등장인물">
    ...
    <t:sheet id="castSheet" title="작품 캐스팅">
    ...
    <t:sheet id="roundCastSheet" title="회차별 캐스팅">
    ...
    <t:sheet id="creditSheet" title="제작진 크레딧">
    ...
    <t:sheet id="mediaSheet" title="공연 미디어" description="파일을 공개 저장소로 복제한 뒤 공연 페이지에 연결해요.">
