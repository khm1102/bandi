...
<t:layout title="멤버·권한" active="members" role="${role}" scriptPath="members/list">
    ...
    <t:sheet id="memberSheet" title="멤버 사전 등록" description="학교 SSO 첫 로그인 전에 학번과 이름, 단일 소속 팀을 등록해요." presentation="form">
    ...
    <t:sheet id="memberRoleSheet" title="멤버 권한 변경" description="변경할 권한과 이력에 남길 사유를 입력해요." presentation="form">
    ...
    <t:sheet id="memberManageSheet" title="멤버 정보 변경" description="팀, 기수 또는 활동 상태 중 한 항목씩 변경해요." presentation="form">
