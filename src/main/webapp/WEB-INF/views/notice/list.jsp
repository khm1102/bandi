...
<t:layout title="공지" active="notices" role="${role}" scriptPath="notice/list">
    ...
    <section class="rounded-lg border bg-card" aria-live="polite">
        ...
        <div class="px-5 py-11 text-center" data-notice-state>
            ...
            <button type="button" class="mt-4 hidden min-h-11 rounded-md border px-4 text-sm font-bold" data-notice-reset>필터 초기화</button>
        </div>
    </section>
    <t:pagination id="noticePagination" label="공지 목록 페이지"/>
