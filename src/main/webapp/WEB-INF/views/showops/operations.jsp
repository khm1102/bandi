...
<t:layout title="공연 운영" active="showops" role="${role}" scriptPath="showops/operations">
    ...
    <div class="rounded-lg border bg-card">
        <t:dataTable caption="관람객 입장 현황">
            ...
            <tr><td><span class="flex items-center gap-2"><span class="flex size-7 shrink-0 items-center justify-center rounded-full bg-success text-xs font-black text-white">김</span><span><b data-entry-name class="block">김수민</b><span class="text-xs text-muted-foreground">2명 신청</span></span></span></td><td class="text-muted-foreground">010-2345-1122</td><td><t:badge tone="info">A3</t:badge> <t:badge tone="info">A4</t:badge></td><td><b>6/21</b> <span class="text-muted-foreground">17:00</span></td><td><t:badge tone="success" dot="true">입장 완료</t:badge></td><td>16:42</td><td class="text-right"><t:button variant="outline" size="compact" pageAction="entry-cancel">입장 취소</t:button></td></tr>
            <tr><td><span class="flex items-center gap-2"><span class="flex size-7 shrink-0 items-center justify-center rounded-full bg-success text-xs font-black text-white">이</span><span><b data-entry-name class="block">이정후</b><span class="text-xs text-muted-foreground">1명 신청</span></span></span></td><td class="text-muted-foreground">010-8811-3344</td><td><t:badge tone="info">C5</t:badge></td><td><b>6/21</b> <span class="text-muted-foreground">17:00</span></td><td><t:badge tone="success" dot="true">입장 완료</t:badge></td><td>16:45</td><td class="text-right"><t:button variant="outline" size="compact" pageAction="entry-cancel">입장 취소</t:button></td></tr>
            <tr><td><span class="flex items-center gap-2"><span class="flex size-7 shrink-0 items-center justify-center rounded-full bg-success text-xs font-black text-white">박</span><span><b data-entry-name class="block">박하은</b><span class="text-xs text-muted-foreground">3명 신청</span></span></span></td><td class="text-muted-foreground">010-5522-7788</td><td><t:badge tone="info">C6</t:badge> <t:badge tone="info">D1</t:badge> <t:badge tone="info">D2</t:badge></td><td><b>6/21</b> <span class="text-muted-foreground">17:00</span></td><td><t:badge tone="success" dot="true">입장 완료</t:badge></td><td>16:51</td><td class="text-right"><t:button variant="outline" size="compact" pageAction="entry-cancel">입장 취소</t:button></td></tr>
            <tr><td><span class="flex items-center gap-2"><span class="flex size-7 shrink-0 items-center justify-center rounded-full bg-info text-xs font-black text-white">최</span><span><b data-entry-name class="block">최유진</b><span class="text-xs text-muted-foreground">2명 신청</span></span></span></td><td class="text-muted-foreground">010-7788-9900</td><td><t:badge tone="info">E4</t:badge> <t:badge tone="info">E5</t:badge></td><td><b>6/21</b> <span class="text-muted-foreground">17:00</span></td><td><t:badge tone="warning" dot="true">미입장</t:badge></td><td class="text-muted-foreground">—</td><td class="text-right"><t:button size="compact" pageAction="entry-checkin">입장 완료</t:button></td></tr>
            <tr><td><span class="flex items-center gap-2"><span class="flex size-7 shrink-0 items-center justify-center rounded-full bg-info text-xs font-black text-white">정</span><span><b data-entry-name class="block">정민석</b><span class="text-xs text-muted-foreground">1명 신청</span></span></span></td><td class="text-muted-foreground">010-3344-5566</td><td><t:badge tone="info">B2</t:badge></td><td><b>6/22</b> <span class="text-muted-foreground">17:00</span></td><td><t:badge tone="warning" dot="true">미입장</t:badge></td><td class="text-muted-foreground">—</td><td class="text-right"><t:button size="compact" pageAction="entry-checkin">입장 완료</t:button></td></tr>
            </tbody>
        </t:dataTable>
    </div>
