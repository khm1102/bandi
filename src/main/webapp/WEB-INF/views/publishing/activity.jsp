...
<t:layout title="활동 기록" active="activity" role="${role}">
    <t:pageHead title="활동 기록" description="팀별 활동을 기록해 불참한 부원도 흐름을 파악합니다">
        <c:if test="${role != 'member'}">
            <button type="button" data-open-modal="activityModal" class="${btnPrimary}">+ 활동 기록</button>
        </c:if>
    </t:pageHead>
    ...
    <div class="flex flex-col gap-3.5">
        ...
        <div class="rounded-lg border bg-card p-5">
            <div class="mb-2 flex items-center gap-2"><t:badge tone="neutral" dot="true">무대팀</t:badge><span class="text-xs text-muted-foreground">06/18 · 참여 6명</span><span class="ml-auto"><t:badge tone="info">사진 2</t:badge></span></div>
            <p class="text-sm leading-relaxed">숲속 세트 90% 완성, 전환용 이동 카트 제작.</p>
        </div>
        <div class="rounded-lg border bg-card p-5">
            <div class="mb-2 flex items-center gap-2"><t:badge tone="neutral" dot="true">오퍼팀</t:badge><span class="text-xs text-muted-foreground">06/17 · 참여 4명</span></div>
            <p class="text-sm leading-relaxed">조명 큐 60% 프로그래밍, 음향 큐시트 작성 중.</p>
        </div>
        <div class="rounded-lg border bg-card p-5">
            <div class="mb-2 flex items-center gap-2"><t:badge tone="neutral" dot="true">디자인팀</t:badge><span class="text-xs text-muted-foreground">06/16 · 참여 3명</span><span class="ml-auto"><t:badge tone="info">사진 4</t:badge></span></div>
