...
<t:layout title="활동 기록" active="activity" role="${role}" scriptPath="activity/list">
    ...
    <t:sheet id="activitySheet" title="활동 기록 작성" description="초안을 저장한 뒤 인증 사진과 함께 제출해요.">
    ...
    <t:sheet id="activityRevisionSheet" title="활동 기록 보완 요청" description="작성자가 다시 확인할 내용을 구체적으로 남겨 주세요.">
