...
<footer class="border-t bg-card px-4 py-7 text-sm text-muted-foreground md:px-6">
    <div class="mx-auto grid max-w-5xl gap-6 md:grid-cols-3">
        <div>
            ...
            <p class="mt-2 text-xs leading-5">동아리 운영과 활동에 관한 공식 안내는 공시에서 제공합니다.</p>
        </div>
        <div>
            <p class="text-xs font-extrabold text-foreground">공시 안내</p>
            <div class="mt-2 flex flex-col gap-1.5 text-xs">
                <a href="<c:url value='/notices'/>" class="w-fit underline-offset-4 hover:text-foreground hover:underline">운영 공시 보기</a>
            </div>
        </div>
        <div>
