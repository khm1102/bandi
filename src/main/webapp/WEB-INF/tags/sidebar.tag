...
<aside id="mainNavigation"
       class="fixed inset-y-0 left-0 z-40 flex w-72 -translate-x-full flex-col overflow-y-auto overscroll-contain bg-sidebar p-4 text-sidebar-foreground transition-transform duration-200 lg:sticky lg:top-0 lg:h-screen lg:w-60 lg:translate-x-0"
    ...
    <nav class="mt-3 flex flex-col gap-1" aria-label="주 메뉴">
        <p class="px-2 pb-1 pt-2 text-xs font-extrabold text-sidebar-muted">기본</p>
        ...
        <a href="<c:url value='/onboarding'/>" class="${navBase} ${active == 'onboarding' ? navOn : navOff}" aria-current="${active == 'onboarding' ? 'page' : 'false'}">
            <svg class="size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18zM12 8v4l3 2"/></svg>처음 시작하기
        </a>
        <p class="px-2 pb-1 pt-3 text-xs font-extrabold text-sidebar-muted">동아리</p>
        ...
        <p class="px-2 pb-1 pt-3 text-xs font-extrabold text-sidebar-muted">활동</p>
        ...
        <p class="px-2 pb-1 pt-3 text-xs font-extrabold text-sidebar-muted">관리</p>
    ...
    <div class="mt-auto flex flex-col gap-3 border-t border-sidebar-border px-2 pt-3">
        <a href="<c:url value='/profile'/>" class="flex min-w-0 items-center gap-2.5 rounded-md p-1.5 transition-colors hover:bg-sidebar-accent" data-session-profile aria-busy="true">
            ...
            <span class="min-w-0 flex-1">
                ...
                <span class="block break-words text-xs leading-4 text-sidebar-muted" data-session-meta>잠시만 기다려 주세요</span>
            </span>
        </a>
        <div class="flex flex-wrap justify-center gap-x-2 text-xs text-sidebar-muted">
            <a href="<c:url value='/privacy'/>" class="inline-flex min-h-11 items-center transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">개인정보 안내</a>
            <span class="flex min-h-11 items-center" aria-hidden="true">·</span>
            <a href="<c:url value='/support'/>" class="inline-flex min-h-11 items-center transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">운영 문의</a>
        </div>
