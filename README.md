...
Copyright © 2026 김현민. All Rights Reserved.

이 저장소의 코드·문서·디자인·로고·이미지는 김현민의 독점적 자산이며, 사전 서면 허가 없이
복제·수정·배포·개인적 사용·상업적 사용·포트폴리오 이용을 할 수 없다. 실제 참여자는 이
저장소의 유지 브랜치에 병합된 GitHub 커밋 이력으로만 인정한다. 기여 사실의 표기는 자신의
실제 기여 범위에 한하며, 기여자에게도 프로젝트 전체의 사용권은 자동으로 부여되지 않는다.

자세한 조건은 [LICENSE](LICENSE)를 따른다.
